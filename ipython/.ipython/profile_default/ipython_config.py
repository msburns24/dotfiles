...
#  Default: "Python 3.14.6 (main, Jun 23 2026, 15:18:23) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.14.6 (main, Jun 23 2026, 15:18:23) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# c.TerminalInteractiveShell.banner1 = "Python 3.14.6 (main, Jun 23 2026, 15:18:23) [Clang 22.1.3 ]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.15.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
## The format for line numbering. Will be passed the current line number ``line``
#  (int, 1 based), and the relative line number ``rel_line``. For example to
#  display both, you can use the following template string:
#  ``c.TerminalInteractiveShell.prompt_line_number_format = '{line:
#  4d}/{rel_line:+03d} | '`` This will display the current line number, with a
#  leading space and a width of at least 4 characters, as well as the relative
#  line number, 0-padded and always with a + or - sign. Note that when using
#  Emacs mode, the prompt of the first line may not update.
#  Default: ''
